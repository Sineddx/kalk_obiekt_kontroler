...
<head>
    ...
    <link rel="stylesheet" href="{$conf->app_url}/fonts/icomoon/style.css">

    <link rel="stylesheet" href="{$conf->app_url}/css/bootstrap.min.css">
    <link rel="stylesheet" href="{$conf->app_url}/css/jquery-ui.css">
    ...
    <link rel="stylesheet" href="{$conf->app_url}/css/jquery.fancybox.min.css">

    <link rel="stylesheet" href="{$conf->app_url}/css/bootstrap-datepicker.css">

    <link rel="stylesheet" href="{$conf->app_url}/fonts/flaticon/font/flaticon.css">

    <link rel="stylesheet" href="{$conf->app_url}/css/aos.css">
...
<div class="site-wrap">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-6 col-xl-2">
                    <h1 class="mb-0 site-logo m-0 p-0"><a href="{$conf->app_url}/app/ctrl.php" class="mb-0">ez</a></h1>
                </div>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url({$conf->app_url}/images/hero_1.jpg);" data-aos="fade" id="home-section">
...
<script src="{$conf->app_url}/js/jquery-migrate-3.0.1.min.js"></script>
<script src="{$conf->app_url}/js/jquery-ui.js"></script>
...
<script src="{$conf->app_url}/js/jquery.countdown.min.js"></script>
<script src="{$conf->app_url}/js/bootstrap-datepicker.min.js"></script>
<script src="{$conf->app_url}/js/jquery.easing.1.3.js"></script>
<script src="{$conf->app_url}/js/aos.js"></script>
<script src="{$conf->app_url}/js/jquery.fancybox.min.js"></script>
<script src="{$conf->app_url}/js/jquery.sticky.js"></script>
{if $hide_intro}
    <script src="{$conf->app_url}/js/skip.js"></script>
{/if}
